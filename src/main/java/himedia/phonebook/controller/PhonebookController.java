...
public class PhonebookController {
	...
	public String modifyForm(@PathVariable("id") Integer id, Model model) {
		...
		// 기존 게시물 가져오기 
		PhonebookVo phonebookVo = phonebookServiceImpl.selectPhonebook(id);		// 가져와서
		model.addAttribute("vo", phonebookVo);									// 모델에 실어서
	...
	// 게시물 수정
	@PostMapping("/modify")
	public String madifyAction(@ModelAttribute PhonebookVo phonebookVo) {
